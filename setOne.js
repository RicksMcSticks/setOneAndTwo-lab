...
// CODE HERE
const theeFunc = (parameter1, parameter2) => (`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)

console.log(theeFunc(`chess`, `baby`))
...
// CODE HERE
pricesPlusTax(prices, (totalCost) => console.log(`The new array prices plus tax =, ${totalCost}`))
